...
class InferencePipeline {
    ...
    public:
        ...
        void allocateTensorMemoryTRT(TensorMapType& tensorMap) {
        ...
        /**
         * @brief Allocate memory for CPU-side postprocessing tensors. All tensors would be float32.
         */
        void allocatePostprocTensors();
         ...
         */
        void copyAndCastForPostProcessing();
    ...
    private:
        ...
        PinnedTensorMap m_HostTensorMap;
